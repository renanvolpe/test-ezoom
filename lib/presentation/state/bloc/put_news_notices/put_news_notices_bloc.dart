...
class PutNewsNoticesBloc extends Bloc<PutNewsNoticesEvent, PutNewsNoticesState> {
  PutNewsNoticesBloc(NewsNoticeRepository newsNoticeRepository) : super(PutNewsNoticesInitial()) {
    ...
    on<PutNewsNoticesReseted>((event, emit) async {
      emit(PutNewsNoticesInitial());
    });
  }
}
